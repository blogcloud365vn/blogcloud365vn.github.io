...
- Ở [Part 2](https://blog.cloud365.vn/logging/ELK-part2-Cai-dat-ELK-stack/ "title" target="_blank") mình đã hướng dẫn cách để có thể cài đặt ELK với mô hình All in one và cách cấu hình trên client đẩy log về hệ thông ELK. 
